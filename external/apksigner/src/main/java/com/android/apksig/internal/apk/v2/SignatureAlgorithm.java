...
public enum SignatureAlgorithm {
    ...
    RSA_PKCS1_V1_5_WITH_SHA256(
            ...
            ContentDigestAlgorithm.CHUNKED_SHA256,
            "RSA",
            Pair.of("SHA256withRSA",(PSSParameterSpec) null)),
    ...
    RSA_PKCS1_V1_5_WITH_SHA512(
            ...
            ContentDigestAlgorithm.CHUNKED_SHA512,
            "RSA",
    Pair.of("SHA512withRSA", (PSSParameterSpec)null)),
    ...
    ECDSA_WITH_SHA256(
            ...
            ContentDigestAlgorithm.CHUNKED_SHA256,
            "EC",
    Pair.of("SHA256withECDSA",(PSSParameterSpec) null)),
    ...
    ECDSA_WITH_SHA512(
            ...
            ContentDigestAlgorithm.CHUNKED_SHA512,
            "EC",
    Pair.of("SHA512withECDSA",(PSSParameterSpec) null)),
    ...
    DSA_WITH_SHA256(
            ...
            ContentDigestAlgorithm.CHUNKED_SHA256,
            "DSA",
    Pair.of("SHA256withDSA",(PSSParameterSpec) null));
