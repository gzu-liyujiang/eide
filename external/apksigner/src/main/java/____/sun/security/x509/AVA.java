...
import ____.sun.security.action.GetBooleanAction;
import ____.sun.security.util.*;
import ____.sun.security.pkcs.PKCS9Attribute;
...
public class AVA implements DerEncoder {
    ...
    // avoid breaking preexisting certificates generated with ____.sun.security APIs.
    private static final boolean PRESERVE_OLD_DC_ENCODING =
        AccessController.doPrivileged(new GetBooleanAction
            ("com.____.sun.security.preserveOldDCEncoding"));
