...
import ____.sun.security.jca.Providers;
import ____.sun.security.pkcs.PKCS7;
import ____.sun.security.pkcs.SignerInfo;
...
public class SignatureFileVerifier {
         ...
         throws IOException, SignatureException
    {
        ...
        if (sfAttr != null) {
            //____.sun.security.util.HexDumpEncoder hex = new ____.sun.security.util.HexDumpEncoder();
