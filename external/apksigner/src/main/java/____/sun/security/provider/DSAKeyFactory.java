...
import ____.sun.security.action.GetPropertyAction;
...
public class DSAKeyFactory extends KeyFactorySpi {
    ...
    private static final String SERIAL_PROP = "____.sun.security.key.serial.interop";
    ...
    static {
         ...
         * JDK 1.4.
         *
         * If true, then we generate ____.sun.security.provider.DSAPublicKey.
         * If false, then we generate ____.sun.security.provider.DSAPublicKeyImpl.
         *
    ...
    protected Key engineTranslateKey(Key key) throws InvalidKeyException {
        ...
        try {
            ...
            if (key instanceof java.security.interfaces.DSAPublicKey) {
                ...
                if (key instanceof ____.sun.security.provider.DSAPublicKey) {
                    return key;
                }
                // Convert key to spec
                ...
                // Check if key originates from this factory
                if (key instanceof ____.sun.security.provider.DSAPrivateKey) {
                    return key;
                }
                // Convert key to spec
