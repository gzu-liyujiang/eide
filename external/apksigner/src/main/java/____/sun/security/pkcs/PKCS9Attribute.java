...
import ____.sun.security.x509.CertificateExtensions;
    ...
    static {
        try {
            ...
            VALUE_CLASSES[3] =        // ContentType
                Class.forName("____.sun.security.util.ObjectIdentifier");
            ...
            VALUE_CLASSES[6] =        // Countersignature
                Class.forName("[L____.sun.security.pkcs.SignerInfo;");
            ...
            VALUE_CLASSES[14] =        // ExtensionRequest
                Class.forName("____.sun.security.x509.CertificateExtensions");
