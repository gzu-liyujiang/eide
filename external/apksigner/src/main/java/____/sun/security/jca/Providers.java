...
public class Providers {
    ...
    //
    // The code here is used by ____.sun.security.util.SignatureFileVerifier.
    // See there for details.

    private static final String BACKUP_PROVIDER_CLASSNAME =
        "____.sun.security.provider.VerificationProvider";
    ...
    private static final String[] jarVerificationProviders = {
        "____.sun.security.provider.Sun",
        "____.sun.security.rsa.SunRsaSign",
        BACKUP_PROVIDER_CLASSNAME,
    };

    // Return to Sun provider or its backup.
    // This method should only be called by
    // ____.sun.security.util.ManifestEntryVerifier and java.security.SecureRandom.
