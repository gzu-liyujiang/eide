...
import ____.sun.security.util.PropertyExpander;
...
final class ProviderConfig {
    ...
    private final static ____.sun.security.util.Debug debug =
        ____.sun.security.util.Debug.getInstance("jca", "ProviderConfig");

    // classname of the SunPKCS11-Solaris provider
    private static final String P11_SOL_NAME =
        "____.sun.security.pkcs11.SunPKCS11";
        ...
        Boolean o = AccessController.doPrivileged(
            ...
            public Boolean run() {
                ...
                if ("false".equalsIgnoreCase(System.getProperty
                        ("____.sun.security.pkcs11.enable-solaris"))) {
                    return Boolean.FALSE;
                }
                return Boolean.TRUE;
            }
