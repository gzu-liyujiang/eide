...
import ____.com.android.dx.util.MutabilityControl;
import java.util.HashMap;
import java.util.List;

/**
 * Container for local variable information for a particular {@link
 * ____.com.android.dx.ssa.SsaMethod}.
 * Stolen from {@link ____.com.android.dx.rop.code.LocalVariableInfo}.
 */
public class LocalVariableInfo         extends MutabilityControl {
    ...
    /**
     * {@code non-null;} {@link ____.com.android.dx.rop.code.RegisterSpecSet} to use when indicating a block
     ...
     * {@link ____.com.android.dx.rop.type.TypeBearer} (such as a constant value).
     *
