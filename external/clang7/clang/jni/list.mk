...
clang_lib_arcmigrate_DIR=$(CLANG_ROOT_PATH)/lib/ARCMigrate

clang_lib_arcmigrate_SRC_FILES:= \
  $(clang_lib_arcmigrate_DIR)/ARCMT.cpp \
  $(clang_lib_arcmigrate_DIR)/ARCMTActions.cpp \
  $(clang_lib_arcmigrate_DIR)/FileRemapper.cpp \
  $(clang_lib_arcmigrate_DIR)/ObjCMT.cpp \
  $(clang_lib_arcmigrate_DIR)/PlistReporter.cpp \
  $(clang_lib_arcmigrate_DIR)/TransAPIUses.cpp \
  $(clang_lib_arcmigrate_DIR)/TransARCAssign.cpp \
  $(clang_lib_arcmigrate_DIR)/TransAutoreleasePool.cpp \
  $(clang_lib_arcmigrate_DIR)/TransBlockObjCVariable.cpp \
  $(clang_lib_arcmigrate_DIR)/TransEmptyStatementsAndDealloc.cpp \
  $(clang_lib_arcmigrate_DIR)/TransGCAttrs.cpp \
  $(clang_lib_arcmigrate_DIR)/TransGCCalls.cpp \
  $(clang_lib_arcmigrate_DIR)/TransProperties.cpp \
  $(clang_lib_arcmigrate_DIR)/TransProtectedScope.cpp \
  $(clang_lib_arcmigrate_DIR)/TransRetainReleaseDealloc.cpp \
  $(clang_lib_arcmigrate_DIR)/TransUnbridgedCasts.cpp \
  $(clang_lib_arcmigrate_DIR)/TransUnusedInitDelegate.cpp \
  $(clang_lib_arcmigrate_DIR)/TransZeroOutPropsInDealloc.cpp \
  $(clang_lib_arcmigrate_DIR)/TransformActions.cpp \
  $(clang_lib_arcmigrate_DIR)/Transforms.cpp
...
clang_lib_codegen_DIR=$(CLANG_ROOT_PATH)/lib/CodeGen

clang_lib_codegen_SRC_FILES:= \
  $(clang_lib_codegen_DIR)/BackendUtil.cpp \
  $(clang_lib_codegen_DIR)/CGAtomic.cpp \
  $(clang_lib_codegen_DIR)/CGBlocks.cpp \
  $(clang_lib_codegen_DIR)/CGBuiltin.cpp \
  $(clang_lib_codegen_DIR)/CGCUDANV.cpp \
  $(clang_lib_codegen_DIR)/CGCUDARuntime.cpp \
  $(clang_lib_codegen_DIR)/CGCXX.cpp \
  $(clang_lib_codegen_DIR)/CGCXXABI.cpp \
  $(clang_lib_codegen_DIR)/CGCall.cpp \
  $(clang_lib_codegen_DIR)/CGClass.cpp \
  $(clang_lib_codegen_DIR)/CGCleanup.cpp \
  $(clang_lib_codegen_DIR)/CGCoroutine.cpp \
  $(clang_lib_codegen_DIR)/CGDebugInfo.cpp \
  $(clang_lib_codegen_DIR)/CGDecl.cpp \
  $(clang_lib_codegen_DIR)/CGDeclCXX.cpp \
  $(clang_lib_codegen_DIR)/CGException.cpp \
  $(clang_lib_codegen_DIR)/CGExpr.cpp \
  $(clang_lib_codegen_DIR)/CGExprAgg.cpp \
  $(clang_lib_codegen_DIR)/CGExprCXX.cpp \
  $(clang_lib_codegen_DIR)/CGExprComplex.cpp \
  $(clang_lib_codegen_DIR)/CGExprConstant.cpp \
  $(clang_lib_codegen_DIR)/CGExprScalar.cpp \
  $(clang_lib_codegen_DIR)/CGGPUBuiltin.cpp \
  $(clang_lib_codegen_DIR)/CGLoopInfo.cpp \
  $(clang_lib_codegen_DIR)/CGNonTrivialStruct.cpp \
  $(clang_lib_codegen_DIR)/CGObjC.cpp \
  $(clang_lib_codegen_DIR)/CGObjCGNU.cpp \
  $(clang_lib_codegen_DIR)/CGObjCMac.cpp \
  $(clang_lib_codegen_DIR)/CGObjCRuntime.cpp \
  $(clang_lib_codegen_DIR)/CGOpenCLRuntime.cpp \
  $(clang_lib_codegen_DIR)/CGOpenMPRuntime.cpp \
  $(clang_lib_codegen_DIR)/CGOpenMPRuntimeNVPTX.cpp \
  $(clang_lib_codegen_DIR)/CGRecordLayoutBuilder.cpp \
  $(clang_lib_codegen_DIR)/CGStmt.cpp \
  $(clang_lib_codegen_DIR)/CGStmtOpenMP.cpp \
  $(clang_lib_codegen_DIR)/CGVTT.cpp \
  $(clang_lib_codegen_DIR)/CGVTables.cpp \
  $(clang_lib_codegen_DIR)/CodeGenABITypes.cpp \
  $(clang_lib_codegen_DIR)/CodeGenAction.cpp \
  $(clang_lib_codegen_DIR)/CodeGenFunction.cpp \
  $(clang_lib_codegen_DIR)/CodeGenModule.cpp \
  $(clang_lib_codegen_DIR)/CodeGenPGO.cpp \
  $(clang_lib_codegen_DIR)/CodeGenTBAA.cpp \
  $(clang_lib_codegen_DIR)/CodeGenTypes.cpp \
  $(clang_lib_codegen_DIR)/ConstantInitBuilder.cpp \
  $(clang_lib_codegen_DIR)/CoverageMappingGen.cpp \
  $(clang_lib_codegen_DIR)/ItaniumCXXABI.cpp \
  $(clang_lib_codegen_DIR)/MacroPPCallbacks.cpp \
  $(clang_lib_codegen_DIR)/MicrosoftCXXABI.cpp \
  $(clang_lib_codegen_DIR)/ModuleBuilder.cpp \
  $(clang_lib_codegen_DIR)/ObjectFilePCHContainerOperations.cpp \
  $(clang_lib_codegen_DIR)/SanitizerMetadata.cpp \
  $(clang_lib_codegen_DIR)/SwiftCallingConv.cpp \
  $(clang_lib_codegen_DIR)/TargetInfo.cpp \
  $(clang_lib_codegen_DIR)/VarBypassDetector.cpp
...
clang_lib_frontendtool_DIR=$(CLANG_ROOT_PATH)/lib/FrontendTool

clang_lib_frontendtool_SRC_FILES:= \
  $(clang_lib_frontendtool_DIR)/ExecuteCompilerInvocation.cpp
...
clang_lib_rewritefrontend_DIR=$(CLANG_ROOT_PATH)/lib/Frontend/Rewrite

clang_lib_rewritefrontend_SRC_FILES:= \
  $(clang_lib_rewritefrontend_DIR)/FixItRewriter.cpp \
  $(clang_lib_rewritefrontend_DIR)/FrontendActions.cpp \
  $(clang_lib_rewritefrontend_DIR)/HTMLPrint.cpp \
  $(clang_lib_rewritefrontend_DIR)/InclusionRewriter.cpp \
  $(clang_lib_rewritefrontend_DIR)/RewriteMacros.cpp \
  $(clang_lib_rewritefrontend_DIR)/RewriteModernObjC.cpp \
  $(clang_lib_rewritefrontend_DIR)/RewriteObjC.cpp \
  $(clang_lib_rewritefrontend_DIR)/RewriteTest.cpp
